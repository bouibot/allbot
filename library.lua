...
do
	...
	function sectionClass:dropdown(data)
		...
		function dropdown:open()
			...
			drop.Position = UDim2.new(self.section.side / 2, 7, 0, self.section.frame.Position.Y.Offset + self.frame.Position.Y.Offset + 60 - (self.section.frame.Parent.CanvasPosition.Y + self.section.frame.CanvasPosition.Y));
